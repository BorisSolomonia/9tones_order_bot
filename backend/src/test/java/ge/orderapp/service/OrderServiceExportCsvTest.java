...
class OrderServiceExportCsvTest {
    ...
    void exportIncludesLocalizedOrderDateAndTimeColumns() {
        ...
        store.putOrderItem(new OrderItemDto("i1", "o1", "Customer", "c1", "Comment", "2026-03-31T06:15:10Z", null, "Address"));
        ...
        assertTrue(csv.startsWith("Order ID,Manager,Order Date,Order Time,Status,Customer,Comment,Board,Address\n"));
        assertTrue(csv.contains("o1,Manager,31.03.2026,10:15:10,SENT,Customer,Comment,,Address"));
    }
}
